...
- `[2026-09-25]` `_unsorted/Adobe Scan 12 Sept 2026.pdf` → `13-circuits-and-systems/exam-pack/NOTES-handwritten-2026-09.pdf` — **NOTES** (learner's own handwriting, 23 pp., titled "Circuits & Systems"). **Triggered creation of `13-circuits-and-systems/`** for **ECE2107** (2025-26 scheme; same precedent as 11 and 12). Scanned PDF with no text layer: rendered to images with PyMuPDF and read visually. Typed + verified transcription: `.../exam-pack/NOTES-class-notes-transcribed.md` (5 errors, 3 gaps flagged). Content overlaps `06-circuits-and-network-theory/` (ECE2120, old scheme, `stage-1✓`).
- `[2026-09-25]` Correction to the entry above: after a high-zoom re-read + circuit simulation, the "5 errors" are revised to **4 pen/unit slips + 1 wording point + 1 question to clarify**. None of the teacher's methods is wrong. Details: `13-circuits-and-systems/progress-log.md`.

- `[2026-09-25]` **17 files in `_unsorted/`, all Engineering Economics (MEE2003)** → **new `14-engineering-economics/exam-pack/`**. MEE2003 is the "Principles of Management / Engineering Economics" slot of the learner's 2025-26 scheme (same precedent as 11, 12, 13). **13 filed:** hand-out (`HANDOUT-MEE2003-course-handout-2026.pdf`, MTE 30 / CWS 30 / ETE 40, MTE after L24) · 10 decks, renamed `slides-L01…` to `slides-L14-19…` · `PRACTICE-L13-EOQ-questions.docx` · `NOTES-L14-19-handwritten-scan.pdf` (scanned notebook, no text layer, read visually). **4 deleted as duplicates, at the learner's request "remove duplicates".** Each one's text is a strict subset of a newer kept file: `Estimation and its types_L10-12.pdf` (older L10-12), `EOQ_L13.ppt` (older L13), `Engg. Economics_Lecture_Payback.pptx` (older L14-19), and `Engg. Economics_Lecture_13_EOQ practice Ques.docx` (the same sheet minus the ROP line). Evidence: `14-engineering-economics/progress-log.md`. **No assignment and no PYQ** in this drop.

- `[2026-09-25]` `_unsorted/33652e6a-….jpg` → `13-circuits-and-systems/exam-pack/SYLLABUS-MTE-2026-09.jpg` — **SYLLABUS** (professor's handwritten MTE syllabus, dated 10/9/26, in the learner's notebook). `_unsorted/WhatsApp Unknown 2026-09-25 at 4.26.41 AM.zip` → unzipped to `13-circuits-and-systems/exam-pack/NOTES-set2-2026-09/p01–p22.jpeg` (+ `MANIFEST.md` mapping original names) — **NOTES** set 2, same lectures as set 1 with more content; zip removed after extraction. Used to extend the study pack (see `13-circuits-and-systems/progress-log.md`).
